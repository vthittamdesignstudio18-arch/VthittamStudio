...
export const projectCategories = [
  {
    ...
    images: [
      ...
      },
      {
        ...
        title: 'Chennai Residence — Alternate View',
        alt: 'Chennai residence at dusk showing the neoclassical portico, columned porch and gated entrance',
      },
      {
        base: '/projects/residential/residential-image-8',
        widths: [400, 800, 1200], ratio: 1.878,
        title: 'Chennai Residence — Front Elevation',
        alt: 'Front elevation of the Chennai residence at dusk with colonnaded facade and lit boundary wall',
      },
      {
